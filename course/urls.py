...
from course.views.subscription import SubscriptionCreateAPIView
...
urlpatterns = [
    ...
    # SUBSCRIPTION URLS
    path('course/<int:pk>/subscribe/', subscription.SubscriptionCreateAPIView.as_view(), name='course-subscribe'),
